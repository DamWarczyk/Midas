...
@Component
public class MidasShopInitializer implements CommandLineRunner {
    ...
    @Autowired
    public MidasShopInitializer(StudentRepo studentRepo, RoleRepo roleRepo, PasswordEncoder passwordEncoder) {
